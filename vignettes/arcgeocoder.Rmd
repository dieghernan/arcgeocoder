...
#>     lon   lat LongLabel                                                                      
#>   <dbl> <dbl> <chr>                                                                          
#> 1  2.29  48.9 Tour Eiffel, Quai Branly, 75007, 7ème Arrondissement, Paris, Île-de-France, FRA
```
...
<div class="figure">
<img src="./eiffel-1.png" alt="Example: Food places near the Eiffel Tower" width="100%" />
<p class="caption">Example: Food places near the Eiffel Tower</p>
</div>
