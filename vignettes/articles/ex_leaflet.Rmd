...
eiffel_icon <- makeIcon(
  iconUrl = system.file("ext/eiffel-tower.png", package = "arcgeocoder"),
...
coffee_icon <- makeIcon(
  iconUrl = system.file("ext/coffee-cup.png", package = "arcgeocoder"),
...
bk_icon <- makeIcon(
  iconUrl = system.file("ext/croissant.png", package = "arcgeocoder"),
  iconWidth = 20, iconHeight = 20,
  iconAnchorX = 10, iconAnchorY = 10
)
