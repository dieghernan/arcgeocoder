...
The following example shows how to create a static map using data retrieved with
**arcgeocoder** and converted to an **sf** object:
...
**tidyterra** package for plotting. The tiles themselves are represented here
as **terra** objects:
