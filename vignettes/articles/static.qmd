...
```{r}
#| label: sf
#| fig-alt: !expr c("A map showing the location of McDonald's restaurants around Barcelona,
#|   Spain", "A map showing the location of McDonald's restaurants in Barcelona, Spain")
library(arcgeocoder)
library(dplyr)
...
```{r}
#| label: terra
#| fig-alt: A map showing the location of McDonald's restaurants in Barcelona, Spain,
#|   over an image provided by CARTO
library(maptiles)
library(tidyterra)
