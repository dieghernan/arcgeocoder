...
**arcgeocoder** accesses the **ArcGIS REST API** without requiring an API key or
an additional HTTP package such as **curl**. It uses base **R** download
functions, which keeps its dependency footprint small.
...
- [**tidygeocoder**](https://jessecambon.github.io/tidygeocoder/)
  ...
  (**OpenStreetMap**), **Google**, **TomTom**, **Mapbox** and other geocoding
  services.
